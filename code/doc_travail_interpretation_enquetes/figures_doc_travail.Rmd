...
# Note: always put TRUE, because updating the data requires to have access to the French Treasury internal files
# Besides, loading existing data enables to reproduce exactly the results from the Document de Travail
