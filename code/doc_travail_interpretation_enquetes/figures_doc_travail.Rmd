...
load("../doc_travail_interpretation_enquetes/data/data_doc_travail_2023-07-18.RData")
...
if (LOAD_EXISTING_DATA_FOR_HEURISTIQUE) {
  load("./data/data_doc_travail_heuristiques_data_20230703.RData")
} else {
  load("../../data/revised_pib_2023-01-01PE.RData")
  heuristiques_survey_data <- load_data_for_nowcasting("../../input/donnees_pour_nowcasting_en_temps_reel.xlsx")
  ...
  save(heuristiques_data, file = "./data/data_doc_travail_heuristiques_data_2023XXXX.RData")
}
